...
const ServerPage = () => {
    ...
    const fetchServers = async () => {
      ...
      try {
        ...
        Swal.fire({
          ...
          text: "Failed to load servers. Please refresh the page.",
          background: "#1e1e2e",
          color: "#ffffff",
  ...
  const handleCreateServer = async () => {
    if (!newServer.name.trim()) {
      Swal.fire({
        ...
        text: "Please enter a server name.",
        background: "#1e1e2e",
        color: "#ffffff",
        confirmButtonColor: "#6366F1",
      });
    ...
    try {
      ...
      if (!token) {
        Swal.fire({
          ...
          text: "You must be logged in to create a server.",
          background: "#1e1e2e",
          color: "#ffffff",
          confirmButtonColor: "#6366F1",
        });
  ...
  const handleJoinServer = async () => {
    if (!serverCode.trim()) {
      Swal.fire({
        icon: "warning",
        title: "Missing Code",
        text: "Please enter a server code.",
        background: "#1e1e2e",
        color: "#ffffff",
        confirmButtonColor: "#6366F1",
      });
    ...
    try {
      ...
      if (!token) {
        Swal.fire({
          icon: "warning",
          title: "Authentication Required",
          text: "You must be logged in to join a server.",
          background: "#1e1e2e",
          color: "#ffffff",
          confirmButtonColor: "#6366F1",
        });
      ...
      if (error.response?.status === 401) {
        ...
        Swal.fire({
          ...
          text: error.response.data.error || "Invalid server code.",
          background: "#1e1e2e",
          color: "#ffffff",
          confirmButtonColor: "#6366F1",
        });
        ...
        Swal.fire({
          icon: "error",
          title: "Invalid Request",
          text: error.response.data.error || "Please check the server code.",
          background: "#1e1e2e",
          color: "#ffffff",
          confirmButtonColor: "#6366F1",
        });
        ...
        Swal.fire({
          icon: "error",
          title: "Join Failed",
          text: "Failed to join server. Please try again.",
          background: "#1e1e2e",
          color: "#ffffff",
          confirmButtonColor: "#6366F1",
        });
  ...
  const handleLeaveServer = async (serverId) => {
    const result = await Swal.fire({
      icon: "warning",
      title: "Leave Server?",
      text: "Are you sure you want to leave this server?",
      background: "#1e1e2e",
      color: "#ffffff",
    ...
    if (result.isConfirmed) {
      try {
        ...
        // Add your leave server API call here
        // await axios.post(`https://quizhippo.pythonanywhere.com/api/servers/${serverId}/leave/`, {}, {
        ...
        Swal.fire({
          icon: "success",
          title: "Left Server",
          text: "You have successfully left the server.",
          background: "#1e1e2e",
          color: "#ffffff",
          confirmButtonColor: "#6366F1",
          timer: 2000,
  ...
  const handleManageServer = (serverId) => {
    Swal.fire({
      icon: "info",
      title: "Manage Server",
      text: "Server management features coming soon!",
      background: "#1e1e2e",
      color: "#ffffff",
      confirmButtonColor: "#6366F1",
    });
