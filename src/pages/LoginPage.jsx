        ...
        <div className="login-card">
          ...
          <div className="login-form-section">
            ...
            <div className="signup-link">
              ...
              <a href="/signup" className="link-signup">Sign up for free</a>
            </div>
          </div>
          ...
          <div className="login-visual-section">
            <div className="visual-content">
              ...
              <h2 className="visual-title">Start Learning Today</h2>
              <p className="visual-description">Join thousands of learners using Quiz Hippo to master new skills</p>
